...
namespace Core.ByteEncryption
{
    class MetadataReader
    {
        ...
        unsafe public struct IMAGE_OPTIONAL_HEADER
        {
            ...
            public int SizeOf哦勒艾艾伊吉dData;
            public int SizeOfUn哦勒艾艾伊吉dData;
    ...
    , "EncBaseId"
            ...
            tablesinfo[0].ctypes = new Types[] {
    Types.UInt16, Types.String, Types.Guid, Types.Guid, Types.Guid
   };
            tablesinfo[1].Name = "TypeRef";
            tablesinfo[1].names = new string[] {
    "ResolutionScope"
    , "Name"
    , "Namespace"
   };
            tablesinfo[1].type = Types.TypeRef;
            tablesinfo[1].ctypes = new Types[] {
    Types.ResolutionScope, Types.String, Types.String
   };
            tablesinfo[2].Name = "TypeDef";
            tablesinfo[2].names = new string[] {
    "Flags"
    , "Name"
    , "Namespace"
    , "Extends"
    ...
    , "MethodList"
            ...
            tablesinfo[2].ctypes = new Types[] {
    Types.UInt32, Types.String, Types.String, Types.TypeDefOrRef, Types.Field, Types.Method
   };
            tablesinfo[3].Name = "FieldPtr";
            tablesinfo[3].names = new string[] {
    "Field"
   };
            tablesinfo[3].type = Types.FieldPtr;
            tablesinfo[3].ctypes = new Types[] {
    Types.Field
   };
            tablesinfo[4].Name = "Field";
            tablesinfo[4].names = new string[] {
    "Flags"
    , "Name"
    , "Signature"
   };
            tablesinfo[4].type = Types.Field;
            tablesinfo[4].ctypes = new Types[] {
    Types.UInt16, Types.String, Types.Blob
   };
            tablesinfo[5].Name = "MethodPtr";
            tablesinfo[5].names = new string[] {
    "Method"
   };
            tablesinfo[5].type = Types.MethodPtr;
            tablesinfo[5].ctypes = new Types[] {
    Types.Method
   };
            tablesinfo[6].Name = "Method";
            tablesinfo[6].names = new string[] {
    "RVA"
    , "ImplFlags"
    , "Flags"
    , "Name"
    ...
    , "ParamList"
            ...
            tablesinfo[6].ctypes = new Types[] {
    Types.UInt32, Types.UInt16, Types.UInt16, Types.String, Types.Blob, Types.Param
   };
            tablesinfo[7].Name = "ParamPtr";
            tablesinfo[7].names = new string[] {
    "Param"
   };
            tablesinfo[7].type = Types.ParamPtr;
            tablesinfo[7].ctypes = new Types[] {
    Types.Param
   };
            tablesinfo[8].Name = "Param";
            tablesinfo[8].names = new string[] {
    "Flags"
    , "Sequence"
    , "Name"
   };
            tablesinfo[8].type = Types.Param;
            tablesinfo[8].ctypes = new Types[] {
    Types.UInt16, Types.UInt16, Types.String
   };
            tablesinfo[9].Name = "InterfaceImpl";
            tablesinfo[9].names = new string[] {
    "Class"
    , "Interface"
   };
            tablesinfo[9].type = Types.InterfaceImpl;
            tablesinfo[9].ctypes = new Types[] {
    Types.TypeDef, Types.TypeDefOrRef
   };
            tablesinfo[0x0A].Name = "MemberRef";
            tablesinfo[0x0A].names = new string[] {
    "Class"
    , "Name"
    , "Signature"
   };
            tablesinfo[0x0A].type = Types.MemberRef;
            tablesinfo[0x0A].ctypes = new Types[] {
    Types.MemberRefParent, Types.String, Types.Blob
   };
            tablesinfo[0x0B].Name = "Constant";
            tablesinfo[0x0B].names = new string[] {
    "Type"
    , "Parent"
    , "Value"
   };
            tablesinfo[0x0B].type = Types.Constant;
            tablesinfo[0x0B].ctypes = new Types[] {
    Types.UInt16, Types.HasConstant, Types.Blob
   };
            tablesinfo[0x0C].Name = "CustomAttribute";
            tablesinfo[0x0C].names = new string[] {
    "Type"
    , "Parent"
    , "Value"
   };
            tablesinfo[0x0C].type = Types.CustomAttribute;
            tablesinfo[0x0C].ctypes = new Types[] {
    Types.HasCustomAttribute, Types.CustomAttributeType, Types.Blob
   };
            tablesinfo[0x0D].Name = "FieldMarshal";
            tablesinfo[0x0D].names = new string[] {
    "Parent"
    , "Native"
   };
            tablesinfo[0x0D].type = Types.FieldMarshal;
            tablesinfo[0x0D].ctypes = new Types[] {
    Types.HasFieldMarshal, Types.Blob
   };
            tablesinfo[0x0E].Name = "Permission";
            tablesinfo[0x0E].names = new string[] {
    "Action"
    , "Parent"
    , "PermissionSet"
   };
            tablesinfo[0x0E].type = Types.Permission;
            tablesinfo[0x0E].ctypes = new Types[] {
    Types.UInt16, Types.HasDeclSecurity, Types.Blob
   };
            tablesinfo[0x0F].Name = "ClassLayout";
            tablesinfo[0x0F].names = new string[] {
    "PackingSize"
    , "ClassSize"
    , "Parent"
   };
            tablesinfo[0x0F].type = Types.ClassLayout;
            tablesinfo[0x0F].ctypes = new Types[] {
    Types.UInt16, Types.UInt32, Types.TypeDef
   };
            tablesinfo[0x10].Name = "FieldLayout";
            tablesinfo[0x10].names = new string[] {
    "Offset"
    , "Field"
   };
            tablesinfo[0x10].type = Types.FieldLayout;
            tablesinfo[0x10].ctypes = new Types[] {
    Types.UInt32, Types.Field
   };
            tablesinfo[0x11].Name = "StandAloneSig";
            tablesinfo[0x11].names = new string[] {
    "Signature"
   };
            tablesinfo[0x11].type = Types.StandAloneSig;
            tablesinfo[0x11].ctypes = new Types[] {
    Types.Blob
   };
            tablesinfo[0x12].Name = "EventMap";
            tablesinfo[0x12].names = new string[] {
    "Parent"
    , "EventList"
   };
            tablesinfo[0x12].type = Types.EventMap;
            tablesinfo[0x12].ctypes = new Types[] {
    Types.TypeDef, Types.Event
   };
            tablesinfo[0x13].Name = "EventPtr";
            tablesinfo[0x13].names = new string[] {
    "Event"
   };
            tablesinfo[0x13].type = Types.EventPtr;
            tablesinfo[0x13].ctypes = new Types[] {
    Types.Event
   };
            tablesinfo[0x14].Name = "Event";
            tablesinfo[0x14].names = new string[] {
    "EventFlags"
    , "Name"
    , "EventType"
   };
            tablesinfo[0x14].type = Types.Event;
            tablesinfo[0x14].ctypes = new Types[] {
    Types.UInt16, Types.String, Types.TypeDefOrRef
   };
            tablesinfo[0x15].Name = "PropertyMap";
            tablesinfo[0x15].names = new string[] {
    "Parent"
    , "PropertyList"
   };
            tablesinfo[0x15].type = Types.PropertyMap;
            tablesinfo[0x15].ctypes = new Types[] {
    Types.TypeDef, Types.Property
   };
            tablesinfo[0x16].Name = "PropertyPtr";
            tablesinfo[0x16].names = new string[] {
    "Property"
   };
            tablesinfo[0x16].type = Types.PropertyPtr;
            tablesinfo[0x16].ctypes = new Types[] {
    Types.Property
   };
            tablesinfo[0x17].Name = "Property";
            tablesinfo[0x17].names = new string[] {
    "PropFlags"
    , "Name"
    , "Type"
   };
            tablesinfo[0x17].type = Types.Property;
            tablesinfo[0x17].ctypes = new Types[] {
    Types.UInt16, Types.String, Types.Blob
   };
            tablesinfo[0x18].Name = "MethodSemantics";
            tablesinfo[0x18].names = new string[] {
    "Semantic"
    , "Method"
    , "Association"
   };
            tablesinfo[0x18].type = Types.MethodSemantics;
            tablesinfo[0x18].ctypes = new Types[] {
    Types.UInt16, Types.Method, Types.HasSemantic
   };
            tablesinfo[0x19].Name = "MethodImpl";
            tablesinfo[0x19].names = new string[] {
    "Class"
    , "MethodBody"
    , "MethodDeclaration"
   };
            tablesinfo[0x19].type = Types.MethodImpl;
            tablesinfo[0x19].ctypes = new Types[] {
    Types.TypeDef, Types.MethodDefOrRef, Types.MethodDefOrRef
   };
            tablesinfo[0x1A].Name = "ModuleRef";
            tablesinfo[0x1A].names = new string[] {
    "Name"
   };
            tablesinfo[0x1A].type = Types.ModuleRef;
            tablesinfo[0x1A].ctypes = new Types[] {
    Types.String
   };
            tablesinfo[0x1B].Name = "TypeSpec";
            tablesinfo[0x1B].names = new string[] {
    "Signature"
   };
            tablesinfo[0x1B].type = Types.TypeSpec;
            tablesinfo[0x1B].ctypes = new Types[] {
    Types.Blob
   };
            tablesinfo[0x1C].Name = "ImplMap";
            tablesinfo[0x1C].names = new string[] {
    "MappingFlags"
    , "MemberForwarded"
    , "ImportName"
    , "ImportScope"
            ...
            tablesinfo[0x1C].ctypes = new Types[] {
    Types.UInt16, Types.MemberForwarded, Types.String, Types.ModuleRef
   };
            tablesinfo[0x1D].Name = "FieldRVA";
            tablesinfo[0x1D].names = new string[] {
    "RVA"
    , "Field"
   };
            tablesinfo[0x1D].type = Types.FieldRVA;
            tablesinfo[0x1D].ctypes = new Types[] {
    Types.UInt32, Types.Field
   };
            tablesinfo[0x1E].Name = "ENCLog";
            tablesinfo[0x1E].names = new string[] {
    "Token"
    , "FuncCode"
   };
            tablesinfo[0x1E].type = Types.ENCLog;
            tablesinfo[0x1E].ctypes = new Types[] {
    Types.UInt32, Types.UInt32
   };
            tablesinfo[0x1F].Name = "ENCMap";
            tablesinfo[0x1F].names = new string[] {
    "Token"
   };
            tablesinfo[0x1F].type = Types.ENCMap;
            tablesinfo[0x1F].ctypes = new Types[] {
    Types.UInt32
   };
            tablesinfo[0x20].Name = "Assembly";
            tablesinfo[0x20].names = new string[] {
    "HashAlgId"
    , "MajorVersion"
    , "MinorVersion"
    , "BuildNumber"
    ...
    , "Locale"
            ...
            tablesinfo[0x20].ctypes = new Types[] {
    Types.UInt32, Types.UInt16, Types.UInt16, Types.UInt16, Types.UInt16, Types.UInt32, Types.Blob, Types.String, Types.String
   };
            tablesinfo[0x21].Name = "AssemblyProcessor";
            tablesinfo[0x21].names = new string[] {
    "Processor"
   };
            tablesinfo[0x21].type = Types.AssemblyProcessor;
            tablesinfo[0x21].ctypes = new Types[] {
    Types.UInt32
   };
            tablesinfo[0x22].Name = "AssemblyOS";
            tablesinfo[0x22].names = new string[] {
    "OSPlatformId"
    , "OSMajorVersion"
    , "OSMinorVersion"
   };
            tablesinfo[0x22].type = Types.AssemblyOS;
            tablesinfo[0x22].ctypes = new Types[] {
    Types.UInt32, Types.UInt32, Types.UInt32
   };
            tablesinfo[0x23].Name = "AssemblyRef";
            tablesinfo[0x23].names = new string[] {
    "MajorVersion"
    , "MinorVersion"
    , "BuildNumber"
    , "RevisionNumber"
    ...
    , "HashValue"
            ...
            tablesinfo[0x23].ctypes = new Types[] {
    Types.UInt16, Types.UInt16, Types.UInt16, Types.UInt16, Types.UInt32, Types.Blob, Types.String, Types.String, Types.Blob
   };
            tablesinfo[0x24].Name = "AssemblyRefProcessor";
            tablesinfo[0x24].names = new string[] {
    "Processor"
    , "AssemblyRef"
   };
            tablesinfo[0x24].type = Types.AssemblyRefProcessor;
            tablesinfo[0x24].ctypes = new Types[] {
    Types.UInt32, Types.AssemblyRef
   };
            tablesinfo[0x25].Name = "AssemblyRefOS";
            tablesinfo[0x25].names = new string[] {
    "OSPlatformId"
    , "OSMajorVersion"
    , "OSMinorVersion"
    , "AssemblyRef"
            ...
            tablesinfo[0x25].ctypes = new Types[] {
    Types.UInt32, Types.UInt32, Types.UInt32, Types.AssemblyRef
   };
            tablesinfo[0x26].Name = "File";
            tablesinfo[0x26].names = new string[] {
    "Flags"
    , "Name"
    , "HashValue"
   };
            tablesinfo[0x26].type = Types.File;
            tablesinfo[0x26].ctypes = new Types[] {
    Types.UInt32, Types.String, Types.Blob
   };
            tablesinfo[0x27].Name = "ExportedType";
            tablesinfo[0x27].names = new string[] {
    "Flags"
    , "TypeDefId"
    , "TypeName"
    , "TypeNamespace"
    , "TypeImplementation"
            ...
            tablesinfo[0x27].ctypes = new Types[] {
    Types.UInt32, Types.UInt32, Types.String, Types.String, Types.Implementation
   };
            tablesinfo[0x28].Name = "ManifestResource";
            tablesinfo[0x28].names = new string[] {
    "Offset"
    , "Flags"
    , "Name"
    , "Implementation"
            ...
            tablesinfo[0x28].ctypes = new Types[] {
    Types.UInt32, Types.UInt32, Types.String, Types.Implementation
   };
            tablesinfo[0x29].Name = "NestedClass";
            tablesinfo[0x29].names = new string[] {
    "NestedClass"
    , "EnclosingClass"
   };
            tablesinfo[0x29].type = Types.NestedClass;
            tablesinfo[0x29].ctypes = new Types[] {
    Types.TypeDef, Types.TypeDef
   };
            ...
            tablesinfo[0x2A].names = new string[] {
    "Number"
    , "Class"
    , "Bound"
    , "Name"
            ...
            tablesinfo[0x2A].ctypes = new Types[] {
    Types.UInt16, Types.TypeDef, Types.TypeDefOrRef, Types.String
   };
            tablesinfo[0x2B].Name = "MethodTyPar";
            tablesinfo[0x2B].names = new string[] {
    "Number"
    , "Method"
    , "Bound"
    , "Name"
            ...
            tablesinfo[0x2B].ctypes = new Types[] {
    Types.UInt16, Types.Method, Types.TypeDefOrRef, Types.String
   };
            tablesinfo[0x2C].Name = "MethodTyPar";
            tablesinfo[0x2C].names = new string[] {
    "Number"
    , "Method"
    , "Bound"
    , "Name"
    ...
    , 5
            ...
            reftables[0].reftypes = new Types[] {
    Types.TypeDef, Types.TypeRef, Types.TypeSpec
   };
            reftables[0].refindex = new int[] {
    1
    , 2
    , 0x1B
   };
            reftables[1].type = Types.HasConstant;
            reftables[1].reftypes = new Types[] {
    Types.Field, Types.Param, Types.Property
   };
            reftables[1].refindex = new int[] {
    04
    , 08
    , 0x17
   };
            reftables[2].type = Types.CustomAttributeType;
            reftables[2].reftypes = new Types[] {
    Types.TypeRef, Types.TypeDef, Types.Method, Types.MemberRef, Types.UserString
   };
            reftables[2].refindex = new int[] {
    01
    , 02
    , 06
    , 0x0A
    , 01
            ...
            reftables[3].reftypes = new Types[] {
    Types.Event, Types.Property
   };
            reftables[3].refindex = new int[] {
    0x14
    , 0x17
   };
            reftables[4].type = Types.ResolutionScope;
            reftables[4].reftypes = new Types[] {
    Types.Module, Types.ModuleRef, Types.AssemblyRef, Types.TypeRef
   };
            reftables[4].refindex = new int[] {
    00
    , 0x1A
    , 0x23
    , 0x01
            ...
            reftables[5].reftypes = new Types[] {
    Types.Field, Types.Param
   };
            reftables[5].refindex = new int[] {
    04
    , 08
   };
            reftables[6].type = Types.HasDeclSecurity;
            reftables[6].reftypes = new Types[] {
    Types.TypeDef, Types.Method, Types.Assembly
   };
            reftables[6].refindex = new int[] {
    02
    , 06
    , 0x20
   };
            reftables[7].type = Types.MemberRefParent;
            reftables[7].reftypes = new Types[] {
    Types.TypeDef, Types.TypeRef, Types.ModuleRef, Types.Method, Types.TypeSpec
   };
            reftables[7].refindex = new int[] {
    02
    , 01
    , 0x1A
    , 06
    , 0x1B
            ...
            reftables[8].reftypes = new Types[] {
    Types.Method, Types.MemberRef
   };
            reftables[8].refindex = new int[] {
    06
    , 0x0A
   };
            reftables[9].type = Types.MemberForwarded;
            reftables[9].reftypes = new Types[] {
    Types.Field, Types.Method
   };
            reftables[9].refindex = new int[] {
    04
    , 06
   };
            reftables[10].type = Types.Implementation;
            reftables[10].reftypes = new Types[] {
    Types.File, Types.AssemblyRef, Types.ExportedType
   };
            reftables[10].refindex = new int[] {
    0x26
    , 0x23
    , 0x27
   };
            reftables[11].type = Types.HasCustomAttribute;
            reftables[11].reftypes = new Types[] {
    Types.Method, Types.Field, Types.TypeRef, Types.TypeDef, Types.Param, Types.InterfaceImpl, Types.MemberRef, Types.Module, Types.Permission, Types.Property, Types.Event, Types.StandAloneSig, Types.ModuleRef, Types.TypeSpec, Types.Assembly, Types.AssemblyRef, Types.File, Types.ExportedType, Types.ManifestResource
   };
            reftables[11].refindex = new int[] {
    06
    , 04
    , 01
    , 02
    ...
    , 0x28
        ...
        public int GetTypeSize(Types trans)
        {
            ...
            {
                var index = (int)trans - 64;
                var codedtokenbits = codedTokenBits[reftables[index].refindex.Length];
                var maxsizekeeped = 65535;
        ...
        public int GetStringIndexSize() => ((tableheader.HeapOffsetSizes & 0x01) != 0) ? 4 : 2;

        public int GetGuidIndexSize() => ((tableheader.HeapOffsetSizes & 0x02) != 0) ? 4 : 2;

        public int GetBlobIndexSize() => ((tableheader.HeapOffsetSizes & 0x04) != 0) ? 4 : 2;
            ...
            try
            {
                ...
                if (inh.ioh.ResourceDirectory.RVA != 0)
                {
                    ...
                    if (NewPos != 0)
                    {
                        ...
                        rsrcsection = reader.ReadBytes(inh.ioh.ResourceDirectory.Size);
                    }
                }
                ...
                // Read .NET Resources:
                if (netdir.ResourceRVA != 0)
                {
                    NewPos = (long)Rva2Offset(netdir.ResourceRVA);
                    if (NewPos != 0)
                    {
                        reader.BaseStream.Position = NewPos;
                        NETResources = reader.ReadBytes(netdir.ResourceSize);
                    }
                }
                ...
                for (int i = 0; i < mh.NumberOfStreams; ++i)
                {
                    ...
                    index++;
                    var padding = ((index % 4) != 0) ? (4 - (index % 4)) : 0;
                    reader.ReadBytes(padding);
                    streams[i].Name = new string(chars)
                     .Trim(new char[] {
       '\0'
                     });
                    ...
                    {
                        var savepoz = reader.BaseStream.Position;
                ...
                for (int i = 0; i < 64; i++)
                {
                    var count = (((tableheader.MaskValid >> i) & 1) == 0) ? 0 : reader.ReadInt32();
    ...
    class bytesGetter
    {
        static byte[][] methodbodies;
        public static void CalculateEncKeys(ModuleDefMD module)
        {
            var moduleDefMD = module;
            var metadataReader = new MetadataReader();
            FileStream fileStream = null;
            BinaryReader binaryReader = null;
            //       fileStream = new FileStream(Console.ReadLine(), FileMode.Open, FileAccess.Read, FileShare.ReadWrite);
            byte[] tester = moduleDefMD.MetaData.PEImage.CreateFullStream().ReadBytes((int)moduleDefMD.MetaData.PEImage.CreateFullStream().Length);
            var mwm = new MemoryStream(tester);
            binaryReader = new BinaryReader(mwm);

            Dictionary<int, uint> dict = new Dictionary<int, uint>();

            if (metadataReader.Intialize(binaryReader))
            {
                //  byte[] array = File.ReadAllBytes(Console.ReadLine());
                methodbodies = new byte[metadataReader.TableLengths[6]][];
                int[] array3 = new int[metadataReader.TableLengths[6]];
                List<int> list = new List<int>();
                List<int> list2 = new List<int>();

                for (int i = 0; i < metadataReader.TableLengths[6]; i++)
                {
                    methodbodies[i] = null;
                    var num2 = 0;
                    array3[i] = metadataReader.Rva2Offset((int)metadataReader.tables[6].members[i][0]);
                    if (array3[i] > 0)
                    {
                        binaryReader.BaseStream.Position = (long)array3[i];
                        var b = (byte)(binaryReader.ReadByte() & 0xff);
                        if ((b & 3) == 2)
                        {
                            num2 = b >> 2;
                            array3[i]++;
                        ...
                        if (num2 > 0)
                        {
                            ...
                            {
                                binaryReader.BaseStream.Position = (long)array3[i];
                                methodbodies[i] = binaryReader.ReadBytes(num2);
                            }
                            catch
                            {
                            }
        ...
        {
            var token2 = 0x06000000;
            foreach (byte[] byter in methodbodies)
            {
                token2++;
                if (token2 == token)
                {
